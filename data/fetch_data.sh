...
#
# rode com:
# docker run --rm -u 0:0 -v "$(pwd):/work -w /work --entrypoint /usr/local/bin/_entrypoint.sh rnaseq bash fetch_real_data.sh 
...
salmon index -t data/ref/S_cerevisia.cdna.all.fa.gz -i data/sc_index
